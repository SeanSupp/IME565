...
map_pickle = open('output_penguin.pickle', 'rb') #to read rb, to save wb?
...
if penguin_file is None:
    ...
    body_mass_g, island_Biscoe, island_Dream, island_Torgerson, sex_female, sex_male]]) #orders need to be matched w/ the clf pickle
   ...
   # To pertain the right order features. ask what it has to do w/ get_dummies?
